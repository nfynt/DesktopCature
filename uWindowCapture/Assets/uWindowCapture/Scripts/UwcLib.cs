...
namespace uWindowCapture
{
    ...
    public static class Lib
    {
        ...
        [DllImport(name, EntryPoint = "StartRTSPStream")]
        public static extern bool StartRTSPStream(int id, string rtspURL, int target_fps, bool enableEncryption);
        [DllImport(name, EntryPoint = "StopRTSPStream")]
        public static extern bool StopRTSPStream();

        public delegate void RtspInterruptCallbackDelegate(string info);

        [DllImport(name, EntryPoint = "RTSPStreamInterrupted")]
        public static extern void RTSPStreamInterrupted(RtspInterruptCallbackDelegate funcPtr);
