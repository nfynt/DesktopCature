...
extern "C"
{
    ...
    UNITY_INTERFACE_EXPORT bool UNITY_INTERFACE_API StartRTSPStream(int id, char* rtspURL, int target_fps, bool enableEncryption) 
    {
        return RtspStreaming::Get().StartStreaming(id, rtspURL, target_fps, enableEncryption);
    }
